...
type PutMetadataReuqest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Metadata      *Metadata              `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *PutMetadataReuqest) Reset() {
	*x = PutMetadataReuqest{}
	mi := &file_movie_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PutMetadataReuqest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PutMetadataReuqest) ProtoMessage() {}

func (x *PutMetadataReuqest) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PutMetadataReuqest.ProtoReflect.Descriptor instead.
func (*PutMetadataReuqest) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{4}
}

func (x *PutMetadataReuqest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PutMetadataReuqest) GetMetadata() *Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *PutMetadataResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type GetAggregateRatingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetAggregateRatingRequest) Reset() {
	*x = GetAggregateRatingRequest{}
	mi := &file_movie_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAggregateRatingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAggregateRatingRequest) ProtoMessage() {}

func (x *GetAggregateRatingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAggregateRatingRequest.ProtoReflect.Descriptor instead.
func (*GetAggregateRatingRequest) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{6}
}

func (x *GetAggregateRatingRequest) GetRecordId() string {
	if x != nil {
		return x.RecordId
	}
	return ""
...
func (x *GetAggregateRatingRequest) GetRecordType() string {
	if x != nil {
		return x.RecordType
	}
	return ""
...
type GetAggregateRatingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RecordValue   float64                `protobuf:"fixed64,1,opt,name=record_value,json=recordValue,proto3" json:"record_value,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetAggregateRatingResponse) Reset() {
	*x = GetAggregateRatingResponse{}
	mi := &file_movie_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAggregateRatingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAggregateRatingResponse) ProtoMessage() {}

func (x *GetAggregateRatingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAggregateRatingResponse.ProtoReflect.Descriptor instead.
func (*GetAggregateRatingResponse) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{7}
}

func (x *GetAggregateRatingResponse) GetRecordValue() float64 {
	if x != nil {
...
type PutRatingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RecordId      string                 `protobuf:"bytes,1,opt,name=record_id,json=recordId,proto3" json:"record_id,omitempty"`
	RatingValue   int32                  `protobuf:"varint,2,opt,name=rating_value,json=ratingValue,proto3" json:"rating_value,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PutRatingResponse) GetRecordId() string {
	if x != nil {
		return x.RecordId
	}
	return ""
...
func (x *PutRatingResponse) GetRatingValue() int32 {
	if x != nil {
		return x.RatingValue
	}
	return 0
...
var file_movie_proto_rawDesc = string([]byte{
	...
	0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x4b, 0x0a, 0x12, 0x50,
	0x75, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x75, 0x71, 0x65, 0x73,
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x25, 0x0a, 0x13, 0x50, 0x75, 0x74, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22,
	0x59, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x52,
	...
	0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x54, 0x79, 0x70, 0x65, 0x22, 0x3f, 0x0a, 0x1a, 0x47, 0x65,
	0x74, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x52, 0x61, 0x74, 0x69, 0x6e, 0x67,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0b,
	0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x8c, 0x01, 0x0a, 0x10,
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x61, 0x74, 0x69, 0x6e,
	0x67, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x72,
	0x61, 0x74, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x53, 0x0a, 0x11, 0x50, 0x75,
	...
	0x72, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01,
	...
	,
...
var file_movie_proto_goTypes = []any{
	...
	(*PutMetadataReuqest)(nil),         // 4: PutMetadataReuqest
	(*PutMetadataResponse)(nil),        // 5: PutMetadataResponse
	(*GetAggregateRatingRequest)(nil),  // 6: GetAggregateRatingRequest
	(*GetAggregateRatingResponse)(nil), // 7: GetAggregateRatingResponse
...
var file_movie_proto_depIdxs = []int32{
	...
	0,  // 2: PutMetadataReuqest.metadata:type_name -> Metadata
	...
	4,  // 5: MetadataService.PutMetadata:input_type -> PutMetadataReuqest
	6,  // 6: RatingService.GetAggregateRating:input_type -> GetAggregateRatingRequest
	...
	7,  // 11: RatingService.GetAggregateRating:output_type -> GetAggregateRatingResponse
